...
SELECT COUNT(*),gender FROM employees WHERE (first_name ='Irena' OR first_name = 'Vidya' OR first_name ='Maya') AND gender='M' OR (first_name ='Irena' OR first_name = 'Vidya' OR first_name ='Maya') AND gender='F' GROUP BY gender;
